...
video = cv2.VideoCapture("C:/Users/lenovo/Downloads/project-C119-template-main/project-C119-template-main/footvolleyball.mp4")
#load tracker 
...
while True:
   #Write the code inside loop here
    ...
    if success:
       ...
       cv2.putText(img,"lost",(20,30),cv2.FONT_HERSHEY_COMPLEX,1,(0,255,0),3)
    goal_track(img,bbox)
    cv2.imshow("test",img)
    key = cv2.waitKey(20)
    if key == 32 :
